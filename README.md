# 📖 Apertale — Interactive Living 3D Book Canvas

> **WebMCP-native 3D canvas for interactive books built with React, Three.js, and WebGL.**  
> Built and open-sourced by [Abdullah Formuli](https://github.com/authrain-cloud-abdullahformuli) ([@abdullahformuli](https://x.com/abdullahformuli)).
...
Built and maintained by **[Abdullah Formuli](https://github.com/authrain-cloud-abdullahformuli)**  
* 🌐 Website: [calplus.app](https://calplus.app)  
* 🛠️ GitHub: [@authrain-cloud-abdullahformuli](https://github.com/authrain-cloud-abdullahformuli)  
* 🐦 X/Twitter: [@abdullahformuli](https://x.com/abdullahformuli)  
* 📬 Contact: `authrainmedia@gmail.com`
